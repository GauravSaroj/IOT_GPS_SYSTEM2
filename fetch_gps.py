...
def get_gps_data():
    ...
    """
    api_key = "d82e5a3f317547aa9a9631fef007bae0"  # Replace with your OpenCage API key
    location = "Gorakhpur"  # Replace with your location or use IP-based geolocation
...
# Check if GPS data was fetched successfully
